...
edu.df.select1 = subset(edu.df,(grantAid >=1000 & grantAid <=9000))
ggplot(aes(x = grantAid, y = minorityEnroll), data = edu.df.select1) + 
  geom_point(alpha = 0.25, color = 'purple') +
  #scale_x_log10(breaks = trans_breaks("log10", function(x) 10^x),
  #              labels = trans_format("log10", math_format(10^.x))) +
  geom_smooth(method = 'lm', color = 'blue') +
...
edu.df.select2 = subset(edu.df,(grantAid >=9000))
ggplot(aes(x = grantAid, y = minorityEnroll), data = edu.df.select2) + 
  geom_point(alpha = 0.25, color = 'purple') +
  #scale_x_log10(breaks = trans_breaks("log10", function(x) 10^x),
  #              labels = trans_format("log10", math_format(10^.x))) +
  geom_smooth(method = 'lm', color = 'blue') +
...
edu.df.select = subset(edu.df,(loanAid >=5000 & loanAid <=10000))
ggplot(aes(x = loanAid, y = minorityEnroll), data = edu.df.select) + 
  geom_point(alpha = 0.25, color = 'purple') +
  #scale_x_log10(breaks = trans_breaks("log10", function(x) 10^x),
  #              labels = trans_format("log10", math_format(10^.x))) +
  geom_smooth(method = 'lm', color = 'blue') +
...
```{r}
edu.df$pergrantAid = edu.df$grantAid*100/edu.df$instateTuition
ggplot(aes(x = pergrantAid, y = minorityEnroll), data = edu.df) + 
  geom_point(alpha = 0.25, color = 'purple') +
  scale_x_log10() +
  geom_smooth(method = 'lm', color = 'blue') +
  ggtitle("Minority Enrollment by Percentage grant Aid Awarded") + 
  theme(plot.title = element_text(hjust = 0.5)) +
  xlab("Average grant Aid Awarded") + 
  ylab("Minority Enrollment")
```
...
```{r}
edu.df$perloanAid = edu.df$loanAid*100/edu.df$instateTuition
ggplot(aes(x = perloanAid, y = minorityEnroll), data = edu.df) + 
  geom_point(alpha = 0.25, color = 'purple') +
  scale_x_log10() +
  geom_smooth(method = 'lm', color = 'blue') +
  ggtitle("Minority Enrollment by Percentage loan Aid Awarded") + 
  theme(plot.title = element_text(hjust = 0.5)) +
  xlab("Average loan Aid Awarded") + 
  ylab("Minority Enrollment")
```
...
```{r}
edu.df$pertotAid = (edu.df$loanAid + edu.df$grantAid)*100/edu.df$instateTuition
edu.df.select = subset(edu.df,(pertotAid > 50 & pertotAid < 500))
ggplot(aes(x = pertotAid, y = minorityEnroll), data = edu.df.select) + 
  geom_point(alpha = 0.25, color = 'purple') +
  scale_x_log10() +
  geom_smooth(method = 'lm', color = 'blue') +
  ggtitle("Minority Enrollment by Percentage total Aid Awarded") + 
  theme(plot.title = element_text(hjust = 0.5)) +
  xlab("Percentage total Aid Awarded") + 
  ylab("Minority Enrollment")
```
